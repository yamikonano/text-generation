...
from sklearn.metrics import classification_report, plot_confusion_matrix,confusion_matrix,roc_curve,precision_recall_curve,plot_roc_curve
...
if __name__ == "__main__":
    ...
    exit()
        ...
        # cm_matrix = pd.DataFrame(data=cm, columns=['high','medium','low'],
...
#     Test_Y_RawLabels = Encoder.inverse_transform(Test_Y)
#     Test_Y_PredLabels = Encoder.inverse_transform(Pred_Y_SVM)   # Use the predicted SVM results
#
...
#         GeneratedSentence = "The security risk level of the vulnerability is "+Predicted_Label
